...
<section class="contacto" id="order">
    ...
    <div class="row">
        ...
        <form action="">
            ...
            <textarea placeholder="Descripción" name="" id="" cols="30" rows="10"></textarea>
...
import CardLider from '../components/CardLider.vue'
...
.contacto{
 ...
 .row form .inputBox input,  .row form textarea{
  padding:1rem;
  margin:1rem 0;
  font-size: 1.7rem;
  color:#333;
